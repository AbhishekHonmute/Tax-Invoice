...
<body>
	<?php
        ...
        $countername=$_SESSION['login_user'];
	?>
	...
	<div id="header">SUPRIME MALL<button id="log_out" onclick="document.location = 'logout.php'">Log Out</button><span id="username"><?php echo $countername;?></span></div>
	<ul id="nav_bar">
		<li><button class="nav_button active" onclick="home_f()" id ="home_but" >Home</button></li>
		<li><button class="nav_button" onclick="document.location='create_bill_counter.php'" id="create_bill_but">Create Bill</button></li>
		<li><button class="nav_button" onclick="stock_f()" id="stock_but">View Stock</button></li>
